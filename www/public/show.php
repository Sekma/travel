    ...
    <li class="list-group-item border-0 border-bottom">
        ...
        <div class="my-2 row">
          <div class="rounded col mx-2" style="width:250px; height:200px; background-image: url(<?= 'https://source.unsplash.com/category/'.$room['room_id'].'/400x400' ?>); background-size:cover; background-position:center">
            ...
            <div class="col">
                <h5 class="text-primary">Ville: <?= $room['neighborhood'] ?></h5>
                <p>Type: <?= $room['room_type'] ?></p>
                <div class="bg-dark opacity-25" style="width: 40px; height:1px"></div>
                <p class="m-0 opacity-75"><small><?= $room['accommodates'] ?> voyageurs.</small></p>
                <p class="m-0 opacity-75"><small><?= (!empty($room['bedrooms']))?$room['bedrooms']:"N/A"; ?> chambres.</small></p>
                <p class="m-0 opacity-75"><small>minimum <?= $room['minstay'] ?> nuits.</small></p>
